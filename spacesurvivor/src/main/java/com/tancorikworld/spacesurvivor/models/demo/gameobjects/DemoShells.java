...
public class DemoShells extends GameObject {
    ...
    public DemoShells(int prog, @NonNull OpenGlProgramCreator programCreator, float currentPositionX, float currentPositionY, int angle) {
        super(prog, currentPositionX, currentPositionY, angle);
        mSelf = new ColoredFigure(SIZE, 9, new SimpleColor(1, 0, 0), prog);
