...
public class DemoGameObject extends GameObject {
    ...
    public DemoGameObject(int prog, @NonNull OpenGlProgramCreator programCreator, float currentPositionX, float currentPositionY, int angle) {
        ...
        // mBasis = new ColoredFigure(110, 50, 5, new SimpleColor(0, 0, 1), programCreator);
        int program = prog;
        mFigure2 = new ColoredFigure(110f, 50, new SimpleColor(0, 0, 1), program);
        mFigure1 = new ColoredFigure(20, 6, new SimpleColor(1, 0, 0), program);
        mFigure = new ColoredFigure(vertex, new SimpleColor(1, 0, 0), program);
    }
